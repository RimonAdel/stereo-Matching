...
if count >3:
    print("usage: $python stereo_Matching_DB.py <path_for_left_image> <path_for_right_image> <window_size>")
    print("window_size = 1, 5, 9")
    sys.exit (1)

imagLPath = arguments[0]
imagRPath = arguments[1]
window_size = int(arguments[2])

print("left image path is: ",imagLPath)
print("right image path is: ",imagRPath)
print("window size: ",window_size)

##calculate disparity map
disparity = disparity_map(imagLPath, imagLPath, window_size)
